...
export function executeWidgetQuery(widget: WidgetSpec, activeFilters: FilterState, overrideGrain?: string): any {
  ...
  if (widget.type === 'google_map' || widget.type === 'geo_map') {
    ...
    const rawPoints = [
      { id: '7E-1082', store_id: '7E-1082', name: 'KLCC Twin Towers Concourse', store_name: 'KLCC Twin Towers Concourse', lat: 3.1578, lng: 101.7123, region: 'Klang Valley / Central', sales: Math.round(38400 * overallVolumeScale), target: targetMap['7E-1082'], manager: 'Ahmad Zaki', nps: 96, pos_count: 8 },
      { id: '7E-2041', store_id: '7E-2041', name: 'Mid Valley Megamall North Court', store_name: 'Mid Valley Megamall North Court', lat: 3.1189, lng: 101.6781, region: 'Klang Valley / Central', sales: Math.round(31200 * overallVolumeScale), target: targetMap['7E-2041'], manager: 'Michelle Tan', nps: 88, pos_count: 6 },
      { id: '7E-0492', store_id: '7E-0492', name: 'Gurney Plaza Waterfront', store_name: 'Gurney Plaza Waterfront', lat: 5.4377, lng: 100.3098, region: 'Northern Region', sales: Math.round(24500 * overallVolumeScale), target: targetMap['7E-0492'], manager: 'Rajeswary S.', nps: 84, pos_count: 5 },
      { id: '7E-3118', store_id: '7E-3118', name: 'JB City Square Customs Hub', store_name: 'JB City Square Customs Hub', lat: 1.4619, lng: 103.7638, region: 'Southern Region', sales: Math.round(28900 * overallVolumeScale), target: targetMap['7E-3118'], manager: 'Kevin Wong', nps: 78, pos_count: 6 },
      { id: '7E-0842', store_id: '7E-0842', name: 'KLIA2 Departure Hall Terminal', store_name: 'KLIA2 Departure Hall Terminal', lat: 2.7456, lng: 101.6841, region: 'Klang Valley / Central', sales: Math.round(42100 * overallVolumeScale), target: targetMap['7E-0842'], manager: 'Noraini Mohd', nps: 98, pos_count: 10 },
      { id: '7E-1934', store_id: '7E-1934', name: 'Ipoh Old Town Heritage', store_name: 'Ipoh Old Town Heritage', lat: 4.5975, lng: 101.0772, region: 'Northern Region', sales: Math.round(16800 * overallVolumeScale), target: targetMap['7E-1934'], manager: 'Chong Wei Lun', nps: 42, pos_count: 4 },
      { id: '7E-4421', store_id: '7E-4421', name: 'Kuantan Teluk Cempedak Beach', store_name: 'Kuantan Teluk Cempedak Beach', lat: 3.8168, lng: 103.3654, region: 'East Coast & Islands', sales: Math.round(19500 * overallVolumeScale), target: targetMap['7E-4421'], manager: 'Fatimah Ali', nps: 68, pos_count: 4 },
      { id: '7E-5512', store_id: '7E-5512', name: 'Kuching Waterfront Heritage', store_name: 'Kuching Waterfront Heritage', lat: 1.5583, lng: 110.3444, region: 'Sabah & Sarawak', sales: Math.round(21400 * overallVolumeScale), target: targetMap['7E-5512'], manager: 'Leonard Jabu', nps: 74, pos_count: 5 }
    ].map(p => {
